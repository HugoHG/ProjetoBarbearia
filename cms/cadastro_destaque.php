...
if(isset($_POST['txtTitulo'])){
    //Definindo visibilidade (ativo ou não) do destaque
    ...
    //salvando no banco
    $sql = "insert into tbl_destaque set titulo = '".$_POST['txtTitulo']."', imagem = '".$nome_foto."', descricao = '".$_POST['txtDetalhes']."', idEstabelecimento = ".$_POST['slcEstabelecimento'].";";
    ...
    <body>
        <div id="main">
            ...
            <div id="content">
                ...
                <form name="frmfoto" method="post" action="uploadfotodestaque.php" enctype="multipart/form-data" id="frmfoto">
                    <input type="file" name="flefoto" id="fotos">
                </form>

                <form name="novo_sobre" method="post" action="cadastro_destaque.php" enctype="multipart/form-data">
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="txtTitulo" required maxlength="100">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <textarea required rows="10" cols="50" style="resize: none" name="txtDetalhes"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
